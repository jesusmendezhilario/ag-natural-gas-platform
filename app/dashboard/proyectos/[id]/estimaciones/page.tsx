    ...
    <div>
      <div style={{ marginBottom: "32px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <SendEmailButton seccion="estimaciones" proyectoNombre={proyecto?.nombre || ""} empresaNombre={empresaNombre} adminEmails={adminEmails} userEmail={userEmail} items={estimaciones || []} />
        </div>
      </div>
