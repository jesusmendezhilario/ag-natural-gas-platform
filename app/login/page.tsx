    ...
    <div style={{ minHeight: "100vh", display: "flex", background: "#f8fafc" }}>
      <div style={{
        ...
        <div style={{ marginBottom: "48px" }}>
          <img src="/logo.webp" alt="AG Natural Gas" style={{ width: "80px", marginBottom: "32px", objectFit: "contain" }} />
          ...
          <p style={{ color: "rgba(255,255,255,0.55)", fontSize: "15px", lineHeight: 1.6 }}>
            Accede a tus proyectos, documentos y dictámenes técnicos en un solo lugar.
          </p>
        </div>
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: "32px" }}>
          <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "12px", letterSpacing: "0.05em", textTransform: "uppercase", marginBottom: "8px" }}>AG Natural Gas</p>
          <p style={{ color: "rgba(255,255,255,0.55)", fontSize: "13px" }}>Querétaro, México</p>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "48px" }}>
        <div style={{ width: "100%", maxWidth: "400px" }}>
          ...
          <p style={{ color: "#64748b", fontSize: "14px", marginBottom: "32px" }}>
            ¿No tienes cuenta?{" "}
            <Link href="/registro" style={{ color: "#137ea8", fontWeight: 500, textDecoration: "none" }}>Regístrate aquí</Link>
          </p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <button
              ...
              style={{
                ...
                fontFamily: "Manrope, sans-serif", marginTop: "4px", transition: "background 0.15s"
              }}
            >
